...
template <typename Dtype>
void caffe_cpu_invpb(const char Trans, const int n, const int nrhs,
    const Dtype* a, Dtype* b);


template <typename Dtype>
void caffe_cpu_svd(const int m, const int n, const Dtype* a, Dtype* u, Dtype* s);

template <typename Dtype>
void caffe_cpu_qr(const int m, const int n,  Dtype* a);

template <typename Dtype>
void caffe_cpu_qrq(const int m, const int n,  Dtype* a);

template <typename Dtype>
void caffe_cpu_inv(const int n, const Dtype *m,  Dtype* a);
